...
| [Delegated Engineering](skills/delegated-engineering/README.md) | 1.0.1 | Вести любую работу в репозитории, включая чтение и простые правки, пока делегированные агенты выполняют задачу |
...
| Delegated Engineering 1.0.1 | [Скачать ZIP](https://github.com/Karikatun/agent-skills/releases/download/delegated-engineering-v1.0.1/delegated-engineering-1.0.1.zip) | [SHA-256](https://github.com/Karikatun/agent-skills/releases/download/delegated-engineering-v1.0.1/delegated-engineering-1.0.1.zip.sha256) |
...
4. Скопируй распакованную папку со всем содержимым в [каталог навыков своего агента](INSTALLATION.ru.md#каталоги-агентов). Для ручной личной установки в Codex документация указывает `$HOME/.agents/skills`; в Windows — `.agents/skills` внутри профиля пользователя. Если родительского каталога ещё нет, создай его.

Например, после ручной личной установки в Codex должен появиться файл:
...
### Вызвать установленный навык в Codex
