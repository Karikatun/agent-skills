...
| [Delegated Engineering](skills/delegated-engineering/README.md) | 2.0.0 | Вести любую работу в репозитории, включая чтение и простые правки, пока делегированные агенты выполняют задачу |
...
| Delegated Engineering 2.0.0 | [Скачать ZIP](https://github.com/Karikatun/agent-skills/releases/download/delegated-engineering-v2.0.0/delegated-engineering-2.0.0.zip) | [SHA-256](https://github.com/Karikatun/agent-skills/releases/download/delegated-engineering-v2.0.0/delegated-engineering-2.0.0.zip.sha256) |
