...
| Delegated Engineering 1.0.0 | [Скачать ZIP](https://github.com/Karikatun/agent-skills/releases/download/delegated-engineering-v1.0.0/delegated-engineering-1.0.0.zip) | [SHA-256](https://github.com/Karikatun/agent-skills/releases/download/delegated-engineering-v1.0.0/delegated-engineering-1.0.0.zip.sha256) |
