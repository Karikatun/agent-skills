...
| [Delegated Engineering](skills/delegated-engineering/README.md) | 1.0.1 | Lead every repository task, including read-only inspection and trivial edits, while delegated agents own the work |
...
| Delegated Engineering 1.0.1 | [Download ZIP](https://github.com/Karikatun/agent-skills/releases/download/delegated-engineering-v1.0.1/delegated-engineering-1.0.1.zip) | [SHA-256](https://github.com/Karikatun/agent-skills/releases/download/delegated-engineering-v1.0.1/delegated-engineering-1.0.1.zip.sha256) |
