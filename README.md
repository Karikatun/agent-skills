...
Delegated Engineering source and latest published release are 2.1.0.
...
| [Delegated Engineering](skills/delegated-engineering/README.md) | 2.1.0 | Lead every repository task, including read-only inspection and trivial edits, while delegated agents own the work |
...
| Delegated Engineering 2.1.0 | [Download ZIP](https://github.com/Karikatun/agent-skills/releases/download/delegated-engineering-v2.1.0/delegated-engineering-2.1.0.zip) | [SHA-256](https://github.com/Karikatun/agent-skills/releases/download/delegated-engineering-v2.1.0/delegated-engineering-2.1.0.zip.sha256) |
